...
#Code to generate data and make plots and visualize the optimal core within the hard partition
if False:
    import matplotlib as plt
    bestcoresizes=[0,0]
    indexset=[7,9]
    for j in range(len(indexset)):
        ...
        plt.pyplot.title('Plot of Road Network with Optimal Core', fontsize=24)
        ...
        ax.set_yticklabels([])
        plt.pyplot.show()
        plt.pyplot.savefig(f"Distribution_{[j]}_k12_nLarg_Core_Periphery_Modified_Bay.pdf")
    print(bestcoresizes)

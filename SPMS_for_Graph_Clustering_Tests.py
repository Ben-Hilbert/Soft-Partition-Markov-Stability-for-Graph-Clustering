...
if False:
    ...
    for i in range(4):
        ...
        ax.set_title('Optimal Distributions for RGGs', fontsize=20)
    ...
    for i in range(4):
        ...
        ax.tick_params(axis='y', labelsize=18)
        ax.tick_params(axis='z', labelsize=18)
        ax.set_title('Optimal Distributions for RGGs with Data', fontsize=20)
        cbar=plt.pyplot.colorbar(surf)
        cbar.ax.tick_params(labelsize=18)
        cbar.ax.yaxis.offsetText.set_fontsize(18)
...
if False: #Code to produce plots of optimal core within the road network
    import matplotlib as plt
    P=np.load("Modified_Bay_Optimal_k_12.npy")
    for i in range(3):
        if i<2:
        ...
        fig,ax=plt.pyplot.subplots(figsize=(8, 6))
        if i==0:
            ax.set_xlim(xmin+(0.4*xdiff),xmax-(0.3*xdiff))
            ax.set_ylim(ymin+(0.12*ydiff),ymin+(0.4*ydiff))
            plt.pyplot.scatter(xdat, ydat, c=[color_map[i] for i in clustering], s=4, linestyle='None', marker='o', alpha=0.5)
            plt.pyplot.scatter(xdat[clustering==7], ydat[clustering==7], c='gray',s=4,linestyle='None',marker='o', alpha=0.5)
            plt.pyplot.scatter(xdat[clustering==12], ydat[clustering==12], color='red',s=4,linestyle='None',marker='o')
            plt.pyplot.title('Road Network with Optimal Core', fontsize=30)
        elif i==1:
            ax.set_xlim(xmin+(0.6*xdiff),xmax)
            ax.set_ylim(ymin+(0.2*ydiff),ymax-(0.33*ydiff))
            plt.pyplot.scatter(xdat, ydat, c=[color_map[i] for i in clustering], s=4, linestyle='None', marker='o', alpha=0.5)
            plt.pyplot.scatter(xdat[clustering==9], ydat[clustering==9], color='olive',s=4,linestyle='None',marker='o', alpha=0.5)
            plt.pyplot.scatter(xdat[clustering==12], ydat[clustering==12], color='red',s=4,linestyle='None',marker='o')
            plt.pyplot.title('Road Network with Optimal Core', fontsize=30)
        else:
            plt.pyplot.scatter(xdat, ydat, c=[color_map[i] for i in clustering], s=2, linestyle='None', marker='o')
            plt.pyplot.title('Bay Area Hard Partition', fontsize=30)
        ax.grid(False)
        ax.set_xlabel('')
        ax.set_ylabel('')
        ax.set_xticks([])
        ...
        plt.pyplot.show()
        plt.pyplot.savefig(f"NEW_Distribution_{[i]}_k12_nLarg_Core_Periphery_Modified_Bay.pdf")
#################################################
